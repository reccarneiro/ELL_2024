...
file_name1 ='Validation_Err_MoM_PL_%ilags_%s.pkl'%(num_lags, Transformation.replace(' ','_'))
file_name2 ='beta_tot_PL_MoM_%ilags_%s.pkl'%(num_lags,Transformation.replace(' ','_'))
